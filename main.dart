...
class MyApp extends StatelessWidget {
  ...
  static const LatLng _center = LatLng(45.521563, -122.677433); // กำหนดตำแหน่งบนแผนที่

  void _onMapCreated(GoogleMapController controller) {
    // การทำงานเมื่อตัวแมพถูกสร้าง
  }
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        '/tuesdayScreen': (context) => const TuesdayScreen(),
        '/wednesdayScreen': (context) => const WednesdayScreen(),
        '/thursdayScreen': (context) => const ThusdayScreen(),
        '/fridayScreen': (context) => const FridayScreen(),
        '/saturdayScreen': (context) => const SaturdayScreen(),
        '/sundayScreen': (context) => const SundayScreen(),
      },
    );
  }
}
